...
ConfigurationTemplate	= "${var.project_name}-GWLB-configuration"
...
provisioner "file" {
    source      = "AutoUpdater-00-00.i386.rpm"
    destination = "/home/admin/AutoUpdater-00-00.i386.rpm"
}
...
provisioner "file" {
    source      = "tpot.pem"
    destination = "/home/admin/tpot.pem"
}
...
provisioner "remote-exec" {
    inline = [
      ...
      "rpm -Uhv --force AutoUpdater-00-00.i386.rpm",
      "autoupdatercli stop",
